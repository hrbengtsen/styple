...
<Preview>
  <Text>This is a text paragraph with some <Link variant="color" href="#">links like this</Link>. There are a couple different variants for <Link href="#">these links</Link> that you see here. That is all.</Text>
</Preview>
