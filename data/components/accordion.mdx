...
See [Radix-UI Accordion (v0.1.6)](https://www.radix-ui.com/docs/primitives/components/accordion) for details. This only covers **styple** abstractions.
...
<Table>
  ...
  <Tbody>
    <Tr>
      <Th><Code>noSeparator?</Code></Th>
      <Td><Code color="normal">boolean</Code></Td>
      <Td>-</Td>
