...
> Styple is made to be customizable as its made with CSS-in-JS framework [Stitches](https://stitches.dev/). This is an opinionated choice, making the underlying styling capabilities of the design system Stitches-based.
